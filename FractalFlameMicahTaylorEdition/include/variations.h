...
#define v0                                                                                                          \
    sumvecx = vadd(sumvecx, vmul(affinedx, variation_weights[1].v));                                                \
    sumvecy = vadd(sumvecy, vmul(affinedy, variation_weights[1].v));    
...
#define v12                                                                                                         \
    const __m256 p12_0 = vpow(vsin( vadd(theta, r)), threevec);                                                     \
    const __m256 p12_1 = vpow(vsin( vsub(theta, r)), threevec);                                                     \
...
#define v14                                                                                                         \
    __m256 o14_x = zerovec;                                                                                         \
    __m256 o14_y = zerovec;                                                                                         \
    for(int i14 = 0; i14 < 8; i14++){                                                                               \
        f32 fx = affinedx.m256_f32[i14];                                                                            \
        f32 fy = affinedy.m256_f32[i14];                                                                            \
        if(fx >= 0.0f && fy >= 0.0f){                                                                               \
            o14_x.m256_f32[i14] = fx;                                                                               \
            o14_y.m256_f32[i14] = fy;                                                                               \
        } else if (fx < 0.0f && fy >= 0.0f){                                                                        \
            o14_x.m256_f32[i14] = 2.0 * fx;                                                                         \
            o14_y.m256_f32[i14] = fy;                                                                               \
        } else if(fx >= 0.0f && fy < 0.0f){                                                                         \
            o14_x.m256_f32[i14] = fx;                                                                               \
            o14_y.m256_f32[i14] = fy / 2.0f;                                                                        \
        } else {                                                                                                    \
            o14_x.m256_f32[i14] = 2.0 * fx;                                                                         \
            o14_y.m256_f32[i14] = fy / 2.0f;                                                                        \
        }                                                                                                           \
...
#define v21                                                                                                         \
    const __m256 csquared = vmul(affinec, affinec);                                                                 \
    const __m256 rpluscsquared = vadd(r, csquared);                                                                 \
...
#define v25                                                                                                         \
    ...
    p1_25.v = vmul(                                                                                                 \
        ...
        vmul(                                                                                                       \
            ...
            parametric_paramaters[25][0].v));                                                                       \
                                                                                                                    \
    __m256 p2_25 = parametric_paramaters[25][1].v;                                                                  \
    f256 t_25;                                                                                                      \
    t_25.v = vadd(                                                                                                  \
                theta,                                                                                              \
                vsub(                                                                                               \
    ...
    for(int i_25 = 0; i_25 < 8; i_25++){                                                                            \
        if(t_25.f[i_25] > p1_25.f[i_25]){                                                                           \
            theta_25.f[i_25] = theta.m256_f32[i_25] - p1_25.f[i_25]/2.0f;                                           \
        } else {                                                                                                    \
            theta_25.f[i_25] = theta.m256_f32[i_25] + p1_25.f[i_25]/2.0f;                                           \
        }                                                                                                           \
    }                                                                                                               \
    __m256 newx_25 = vmul(r, vsin(theta_25.v));                                                                     \
    __m256 newy_25 = vmul(r, vcos(theta_25.v));                                                                     \
                                                                                                                    \
    sumvecx = vadd(                                                                                                 \
                sumvecx,                                                                                            \
                vmul(                                                                                               \
...
#define v30                                                                                                         \
    __m256 p1_30 = parametric_paramaters[30][0].v;                                                                  \
    __m256 p2_30 = parametric_paramaters[30][1].v;                                                                  \
    __m256 mult_30 = vdiv(                                                                                          \
                        p2_30,                                                                                      \
                        vsub(                                                                                       \
                            p2_30,                                                                                  \
